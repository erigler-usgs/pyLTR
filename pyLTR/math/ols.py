"""
Ordinary Least Squares (OLS) to generate multiple linear regression
taken from SciPy CookBook [http://www.scipy.org/Cookbook/OLS] is used
by the pyLTR Solar Wind processor to compute Bx linear fit
coefficients.
"""
